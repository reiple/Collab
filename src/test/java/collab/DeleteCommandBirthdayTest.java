...
class DeleteCommandBirthdayTest {
  ...
  @Test
  void testSearchBirthdayAndDeleteFail() {
    ICommand command = new DeleteCommand(
        new NoneFirstOption(), new NoneSecondOption(Arrays.asList("birthday", "20071101"))
    );
  ...
  @Test
  void testSearchBirthdayAndDeleteSuccess() {
    ICommand command = new DeleteCommand(
        new NoneFirstOption(), new NoneSecondOption(Arrays.asList("birthday", "19911021"))
    );
