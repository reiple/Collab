...
public class YearOfBirthdayOptionTest {
  ...
  @Test
  void testYearOfBirthdaySearchFail() {
    YearOfBirthdayOption yearOfBirthdayOption = new YearOfBirthdayOption(Arrays.asList("birthday", "1997"));
