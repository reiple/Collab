...
class MonthOfBirthdayOptionTest {
  ...
  @Test
  void testMonthOfBirthdaySearchFail() {
    MonthOfBirthdayOption monthOfBirthdayOption = new MonthOfBirthdayOption(Arrays.asList("birthday", "05"));
