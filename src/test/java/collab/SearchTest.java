...
class SearchTest {
  ...
  public void searchTest_EmployeeNum(boolean isMatch, Employee answer) {
    List<Employee> foundList = empDB.searchItems(Columns.COLUMN_EMPLOYEE_NUM, answer.getEmployeeNumber());
  ...
  public void searchTest_Name(boolean isMatch, Employee answer) {
    List<Employee> foundList = empDB.searchItems(Columns.COLUMN_NAME, answer.getName());
  ...
  public void searchTest_Cl(boolean isMatch, Employee answer) {
    List<Employee> foundList = empDB.searchItems(Columns.COLUMN_CARRER_LEVEL, answer.getCareerLevel());
  ...
  public void searchTest_PhoneNum(boolean isMatch, Employee answer) {
    List<Employee> foundList = empDB.searchItems(Columns.COLUMN_PHONE_NUMBER, answer.getPhoneNumber());
  ...
  public void searchTest_BirthDay(boolean isMatch, Employee answer) {
    List<Employee> foundList = empDB.searchItems(Columns.COLUMN_BIRTHDAY, answer.getBirthday());
  ...
  public void searchTest_Certi(boolean isMatch, Employee answer) {
    List<Employee> foundList = empDB.searchItems(Columns.COLUMN_CERTIFICATE, answer.getCerti());
