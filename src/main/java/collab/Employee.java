...
public class Employee {
    ...
    public Employee(List<String> commandArguments) {
        fieldHashMap.put(employeeNumberFieldName,
            new EmployeeNumberField(employeeNumberFieldName, commandArguments.get(0)));
        fieldHashMap.put(nameFieldName, new NameField(nameFieldName, commandArguments.get(1)));
        fieldHashMap.put(careerLevelFieldName,
            new CareerLevelField(careerLevelFieldName, commandArguments.get(2)));
        fieldHashMap.put(phoneNumberFieldName,
            new PhoneNumberField(phoneNumberFieldName, commandArguments.get(3)));
        fieldHashMap.put(birthdayFieldName,
            new BirthdayField(birthdayFieldName, commandArguments.get(4)));
        fieldHashMap.put(certiFieldName, new CertiField(certiFieldName, commandArguments.get(5)));
    }

    public void setEmployeeNumber(String str) {
        fieldHashMap.get(employeeNumberFieldName).setData(str);
    }

    public void setPhoneNumber(String str) {
        fieldHashMap.get(phoneNumberFieldName).setData(str);
    }

    public void setName(String str) {
        fieldHashMap.get(nameFieldName).setData(str);
    }

    public void setBirthday(String str) {
        fieldHashMap.get(birthdayFieldName).setData(str);
    }

    public void setCareerLevel(String str) {
        fieldHashMap.get(careerLevelFieldName).setData(str);
    }

    public void setCerti(String str) {
        fieldHashMap.get(certiFieldName).setData(str);
    }

    public String getEmployeeNumber() {
        return fieldHashMap.get(employeeNumberFieldName).getData();
    }

    public String getPhoneNumber() {
        return fieldHashMap.get(phoneNumberFieldName).getData();
    }

    public String getName() {
        return fieldHashMap.get(nameFieldName).getData();
    }

    public String getBirthday() {
        return fieldHashMap.get(birthdayFieldName).getData();
    }

    public String getCareerLevel() {
        return fieldHashMap.get(careerLevelFieldName).getData();
    }

    public String getCerti() {
        return fieldHashMap.get(certiFieldName).getData();
    }
